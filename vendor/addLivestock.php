...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$requette_sql = "INSERT INTO livestock (type,categorie,Troupeau,sexe,ID,name,numero,description,DateNaissance,PoidsNaissance,dateAchat,AcheteDe,PrixAchat,PoidsAchat) values('$type','$categorie','$Troupeau','$sexe','$ID','$name','$numero','$description','$DateNaissance','$PoidsNaissance','$dateAchat','$AcheteDe','$PrixAchat','$PoidsAchat')";
