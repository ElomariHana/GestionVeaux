...
<div class="container">
 ...
 <a style="float:right" href="exportVente.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
	...
	<div class="input-group">
	  ...
	  <br> <a href="createVente.php">Add vente</a>
    </div>
  </div>
</div>
