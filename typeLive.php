...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$requette_sql = "INSERT INTO typeliv (type) values('$type')";
	}else if ($action == "modifier") {
		$id = $_POST['id'];
	$requette_sql = "update typeliv set type='$type' where id='$id'";
	} 
...
if ($action1 == "delete") {
	$id = $_GET['id'];
	$db = new PDO('mysql:host=localhost;dbname=livestock;charset=utf8', 'root', '');
	$cat = $db->query("delete FROM typeliv WHERE id='$id'");
}
...
<tr> <td></td> <td>
 <form action='typeLive.php' method='post'>
<?php
$db = new PDO('mysql:host=localhost;dbname=livestock;charset=utf8', 'root', '');
$cat = $db->query("SELECT * FROM typeliv");
...
<table class="table table-bordered" id="dataTable" width="50%" cellspacing="0">
    ...
    <tbody>';
				...
				echo"<td><a href='typeLive.php?action1=edite&id=".$data['id']."'><img src='images/edit.png' alt='' title='' border='0' /></a>
				<a href='typeLive.php?action1=delete&id=".$data['id']."' class='ask'><img src='images/Remove-Male-User.png' alt='' title='' border='0' /></a>
				</td>";
			echo "</tr>";
